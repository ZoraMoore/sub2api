...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	modelMarketplaceService := service.NewModelMarketplaceService(channelService, groupRepository, groupCapacityService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerPaymentHandler, paymentWebhookHandler, modelMarketplaceHandler, idempotencyCoordinator, idempotencyCleanupService)
