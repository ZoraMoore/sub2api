export default {
  ...
  marketplace: {
    badge: '公开模型广场',
    title: '模型广场',
    description: '浏览平台已接入模型、价格与可用容量，快速选择适合当前任务的模型分组。',
    disabledHint: '模型广场功能当前未开启。管理员开启后，侧边栏入口会对用户可见。',
    searchPlaceholder: '搜索模型、分组、平台或品牌...',
    refresh: '刷新',
    empty: '暂无可展示的模型',
    emptyHint: '请尝试调整搜索条件，或等待管理员配置可展示的模型分组。',
    loadFailed: '加载模型广场失败',
    totalModels: '模型数',
    totalGroups: '可用分组',
    todayTokens: '今日 Token',
